...
export const RODS = Object.freeze([
  {
    ...
    lineStrength: 1,
    luckBonus: 0,
    ability: { id: "quick-hook", name: "Quick Hook", description: "Longer bite window for faster hook sets." },
  ...
  },
  {
    ...
    lineStrength: 1.15,
    luckBonus: 0.025,
    ability: { id: "line-stabilizer", name: "Line Stabilizer", description: "Reduces line drain during rough fights." },
  ...
  },
  {
    ...
    lineStrength: 1.16,
    luckBonus: 0.045,
    ability: { id: "sonar-pulse", name: "Sonar Pulse", description: "Reveals the next target and restores a little line." },
  ...
  },
  {
    ...
    luckBonus: 999,
    cheatOnly: true,
    ability: { id: "sonar-pulse", name: "Omega Pulse", description: "A developer rod with impossible performance." },
    icon: { primary: "#ffffff", secondary: "#ff7d67" },
    summary: "Developer-only rod. Obtain it through the cheat console.",
  },
]);
